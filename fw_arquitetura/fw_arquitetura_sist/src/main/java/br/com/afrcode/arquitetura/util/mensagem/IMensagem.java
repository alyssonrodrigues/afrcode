 ...
 * Ver ITratadorMensagem. Cada tratador de mensagens saberá como formatar e como proceder em relação a mensagem.
 * 
...
public interface IMensagem {
    ...
    /**
     * Método para tratar a mensagem em geral através de uma implementação de ITratadorMensagem.
     */
    void tratarMensagem();
