...
public class EntityManagerFactoryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        if (!"off".equals(hibernateHbm2ddlAuto)
                && !ApplicationContextUtils.isEjbSpringApplicationContext(applicationContext)) {
            jpaProperties.put(HIBERNATE_HBM2DDL_AUTO, hibernateHbm2ddlAuto);
        }
        // Property não obtida por @Value por ser opcional.
        String hibernateDefaultSchema = applicationContext.getEnvironment().getProperty(HIBERNATE_DEFAULT_SCHEMA);
        ...
        // Transactions)
        jpaProperties.put(HIBERNATE_TRANSACTION_FACTORY_CLASS, CMTTransactionFactory.class.getName());
        jpaProperties.put(HIBERNATE_TRANSACTION_JTA_PLATFORM, JBossAppServerJtaPlatform.class.getName());
        ...
        jpaProperties.put(HIBERNATE_CACHE_REGION_PROVIDER_CLASS, EhCacheRegionFactory.class.getName());
        jpaProperties.put(HIBERNATE_CACHE_USE_QUERY_CACHE, Boolean.FALSE.toString());
