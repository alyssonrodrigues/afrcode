 ...
 * 
 */
public class TratadorMensagemInfoNegocio extends
		TratadorMensagemAbstrato<MensagemInfoNegocio> {
	...
	public void tratarMensagem(MensagemInfoNegocio mensagem) {
		...
		LOG.info("Mensagem de informação de negócio obtida e tratada: "
				+ msgSummary);
	}
