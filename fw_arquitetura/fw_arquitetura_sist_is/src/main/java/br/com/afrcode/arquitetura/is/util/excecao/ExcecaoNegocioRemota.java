 ...
 * remotos. Este será o tipo de exceção de negócio visto pelos clientes de
 * serviços remotos.
 * 
 ...
 * regras de negócio devem ser relançadas usando este, E SOMENTE este, tipo,
...
public class ExcecaoNegocioRemota extends RuntimeException {
    ...
    /**
     * Retorna a serveridade do erro de negócio remoto
     * 
     * @return
     */
    ...
    /**
     * Seta a severidade do erro de negócio remoto
     * 
     * @param severidade
     */
