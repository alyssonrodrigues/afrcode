 ...
 * 
 * Para o profile de Batch basta definir um autenticador JAAS para autenticação
 * de um PRINCIPAL com ROLE padrão. Ver LoginModuleParaBatch e suas definições.
 * 
 * 
 */
@Configuration
