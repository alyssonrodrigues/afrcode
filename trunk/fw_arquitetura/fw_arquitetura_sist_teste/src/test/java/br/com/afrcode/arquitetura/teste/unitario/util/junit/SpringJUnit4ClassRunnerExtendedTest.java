...
public class SpringJUnit4ClassRunnerExtendedTest {
    ...
    private static final Logger LOG = Logger.getLogger(SpringJUnit4ClassRunnerExtendedTest.class);
    ...
    public static void verificarNumExecucoes() {
        Assert.assertEquals("O método testarSpringTURepeatAnnotation deveria ter sido executado " + NUM_MAX_EXECUCOES
                + " vezes!", NUM_MAX_EXECUCOES, numExecucoes);
        numExecucoes = 0;
    }
