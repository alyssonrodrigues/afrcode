...
/**
 * Subclasse de DaoJpaAbstrato cujo objetivo é expor serviços específicos da solução Hibernate JPA.
 * 
...
public abstract class DaoHibernateJpaAbstrato<T extends Comparable<T>, E extends IEntidade<T>>
    ...
    /**
     * Método de acesso a Session do Hibernate para uso de funcionalidades específicas do Hibernate.
     * 
     * ATENÇÃO: Deve-se dar preferência ao uso dos recursos JPA disponíveis via getEntityManager().
     * 
     * @return
     */
