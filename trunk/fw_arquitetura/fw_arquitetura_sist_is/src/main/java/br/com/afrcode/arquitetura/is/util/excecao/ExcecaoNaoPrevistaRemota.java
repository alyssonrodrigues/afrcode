 ...
 * serviços remotos.
 * 
 * Serviços remotos expõe serviçs locais de sistemas que por sua vez implementam
 * regras de negócio locais. Exceções locais, não previstas, a estas regras de
 * negócio locais devem ser relançadas usando este, E SOMENTE este, tipo,
 * ExcecaoNaoPrevistaRemota.
 * 
