    ...
    return (
      <Deck transition={["zoom", "slide"]} transitionDuration={500} theme={theme}>
        ...
        <Slide transition={["fade"]} bgColor="primary" textColor="tertiary">
          ...
          <CodePane lang="js" source={require("raw-loader!./component.example")}></CodePane>
        </Slide>
        ...
        <Slide transition={["fade"]} bgColor="secondary" textColor="primary">
          <BlockQuote>
            <Quote>Controller, ModelView, and View are coupled: when you change one, you often have to change the others</Quote>
          </BlockQuote>
        </Slide>
        ...
        <Slide transition={["fade"]} bgColor="secondary" textColor="primary">
          <Table>
            <TableRow>
              <TableHeaderItem padding="10px" textSize="xx-large"></TableHeaderItem>
        ...
        <Slide transition={["fade"]} bgColor="secondary" textColor="primary">
          ...
          <List>
            ...
            <ListItem margin="20px 0 0" textSize="xx-large">UI description and UI logic are tightly coupled and can be colocated - they shouldn't be arbitrarily decoupled</ListItem>
        ...
        <Slide transition={["fade"]} bgColor="primary" textColor="secondary">
          ...
          <List>
            ...
            <ListItem margin="20px 0 0" textSize="x-large">
              <Link href="https://insights.stackoverflow.com/survey/2017#technology-most-loved-dreaded-and-wanted-frameworks-libraries-and-other-technologies" target="_blank">Most Loved Frameworks, Libraries and Other Technologies</Link>
            </ListItem>
            <ListItem margin="20px 0 0" textSize="x-large">
              <Link href="http://stateofjs.com/2016/frontend/" target="_blank">Front-end Frameworks</Link>
            </ListItem>
            <ListItem margin="20px 0 0" textSize="x-large">
              <Link href="https://insights.stackoverflow.com/survey/2017#technology-most-popular-languages-by-occupation" target="_blank">Most Popular Languages by Occupation</Link>
            </ListItem>
            <ListItem margin="20px 0 0" textSize="x-large">
              <Link href="https://www.thoughtworks.com/de/radar/languages-and-frameworks" target="_blank">Languages and Frameworks</Link>
            </ListItem>
            <ListItem margin="20px 0 0" textSize="x-large">
              <Link href="https://medium.com/unicorn-supplies/angular-vs-react-vs-vue-a-2017-comparison-c5c52d620176" target="_blank">Angular vs. React vs. Vue: A 2017 comparison</Link>
            </ListItem>
          </List>
        </Slide>
        <Slide transition={["zoom"]} bgColor="primary">
        ...
        <Slide transition={["zoom"]} bgColor="primary">
          ...
          <CodePane lang="js" source={require("raw-loader!./email.example")}></CodePane>
        </Slide>
      </Deck>
    );
  }
