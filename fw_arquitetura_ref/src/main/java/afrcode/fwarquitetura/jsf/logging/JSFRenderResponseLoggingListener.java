...
/**
 * Listener de fase JSF 2 responsável por finalizar as rotinas de monitoramento de aplicação.
 * 
...
public class JSFRenderResponseLoggingListener implements PhaseListener {
    ...
    public void afterPhase(PhaseEvent event) {
        ...
        if (false) {
            ...
            // TODO: Chamada ao serviço de monitoramento para demarcação de fim...
        }
        LOG.info(getPhaseId() + " / SpringCtx " + webCtx.getDisplayName() + ": demarcação de fim de monitoramento!");
    }
